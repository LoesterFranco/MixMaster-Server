...
namespace Login_Server.MixMaster_API.Database
{
    public class Member
    {
        static string myConnectionString = "Persist Security Info=False;server=" + MyInfo.mysql_host + ";uid=" + MyInfo.mysql_user + ";pwd="+MyInfo.mysql_pass+";database="+MyInfo.mysql_dbname+";";
        ...
        public static int UpdateIDX(string username)
        {
            int id_idx = 0;
            if(conn.State == ConnectionState.Open)
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "SELECT id_idx FROM player WHERE PlayerID='"+username+"';";
